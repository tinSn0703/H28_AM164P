...
class C_AD_mem : protected C_AD
{
	...
	protected:
	void Set_data(usint );
	void Set(E_NUM_AD ,E_LOGIC );
	
	public:
	C_AD_mem()	{}	
	C_AD_mem(E_NUM_AD ,E_LOGIC );
...
inline void C_AD_mem::Set(E_NUM_AD _arg_ad_mem_num,E_LOGIC _arg_ad_mem_io_turn = TRUE)
{
...
//public
inline C_AD_mem::C_AD_mem(E_NUM_AD _arg_ad_mem_num,E_LOGIC _arg_ad_mem_io_turn = TRUE)
