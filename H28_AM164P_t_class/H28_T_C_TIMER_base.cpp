...
class C_TIMER_base
{
	...
	#define COUNTERL	_SFR_MEM8(0x80 + Ret_base_mode())
...
inline void C_TIMER_base::Set_base(E_TIMER_MODE _arg_timer_mode , E_LOGIC _arg_timer_nf_isr = FALES)
{
	TCCR1A = 0x00;
...
inline void C_TIMER_base::Set_mode(E_TIMER_MODE _arg_timer_mode, E_LOGIC _arg_timer_nf_isr = FALES)
{
